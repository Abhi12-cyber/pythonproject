...
def DisplayForm():
    root = Tk()
    root.geometry("1250x1100")
    root.maxsize(2000,2000)
    root.minsize(1000,1000)
    root.title("Student Management System (BY Abhishek)")
    var1=Label(text="Store the data of your section correctly ")
    var1.pack()
    ...
    LeftViewForm = Frame(root, width=500, bg="pink", bd=7)
    ...
    lbl_txtsearch = Label(LFrom, text="Enter Student Details", font=('Arial Bold', 14), bg="pink")
    lbl_txtsearch.pack()
